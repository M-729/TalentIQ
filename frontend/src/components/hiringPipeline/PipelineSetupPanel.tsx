  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-lg font-bold text-foreground">Pipeline Setup</h2>
          <p className="text-sm text-muted-foreground">The ordered stages candidates move through for this job.</p>
        </div>
