          ...
          <tbody>
            {offers.map((row) => (
              <tr key={row.id} className="border-b border-border last:border-0 hover:bg-muted/40">
                ...
                <td className="px-4 py-3 text-foreground">{row.job.title}</td>
                ...
                <td className="px-4 py-3 text-foreground">{formatSalary(row)}</td>
                <td className="px-4 py-3 text-muted-foreground">{row.start_date ? formatDate(row.start_date) : "—"}</td>
                <td className="px-4 py-3 text-muted-foreground">{row.sent_at ? formatDate(row.sent_at) : "—"}</td>
