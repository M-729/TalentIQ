...
// Standard shadcn-style Radix Dialog wrapper — the first one in this
// codebase. Radix handles focus trapping, Escape-to-close, and
// aria-modal/aria-labelledby wiring, which is what makes this reliably
// keyboard-usable without hand-rolling that behavior.
